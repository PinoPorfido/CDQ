...
namespace CDQ.Models.Helper
{
    public class HelpRelazione
    {
        ...
        public AnnotazioniAggiuntive AnnotazioniAggiuntive { get; set; }
        ...
        public IEnumerable<AnnotazioniAggiuntive> ListaAnnotazioniAggiuntive;
